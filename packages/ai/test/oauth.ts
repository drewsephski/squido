/**
 * Test helper for resolving API keys from ~/.squido/agent/auth.json
 *
...
const AUTH_PATH = join(homedir(), ".squido", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.squido/agent/auth.json
 *
