...
```bash
npm install @drewsepsi/squido-ai
```

TypeBox exports are re-exported from `@drewsepsi/squido-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@drewsepsi/squido-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@drewsepsi/squido-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@drewsepsi/squido-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@drewsepsi/squido-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@drewsepsi/squido-ai';
...
```typescript
import { getModel, stream } from '@drewsepsi/squido-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@drewsepsi/squido-ai';
...
```typescript
import { Model, stream } from '@drewsepsi/squido-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@drewsepsi/squido-ai';
...
```typescript
import { getModel, complete, Context } from '@drewsepsi/squido-ai';
...
```typescript
import { Context, getModel, complete } from '@drewsepsi/squido-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@drewsepsi/squido-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@drewsepsi/squido-ai';
...
```bash
npx @drewsepsi/squido-ai login              # interactive provider selection
npx @drewsepsi/squido-ai login anthropic    # login to specific provider
npx @drewsepsi/squido-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@drewsepsi/squido-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@drewsepsi/squido-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@drewsepsi/squido-ai/oauth';
...
```typescript
import { getModel, complete } from '@drewsepsi/squido-ai';
import { getOAuthApiKey } from '@drewsepsi/squido-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@drewsepsi/squido-ai`
