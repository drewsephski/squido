...
export function getPackageDir(): string {
	...
	const envDir = process.env.SQUIDO_PACKAGE_DIR;
	if (envDir) {
...
const DEFAULT_SHARE_VIEWER_URL = "https://squidagent.app/session/";
...
// =============================================================================
// User Config Paths (~/.squido/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.squido/agent/) */
