...
const MIGRATION_GUIDE_URL = "https://github.com/drewsephski/squido/blob/main/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL = "https://github.com/drewsephski/squido/blob/main/docs/extensions.md";
...
/**
 * Migrate sessions from ~/.squido/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.squido/agent/ instead of
 * ~/.squido/agent/sessions/<encoded-cwd>/. This migration moves them
 * to the correct location based on the cwd in their session header.
 *
 * See: https://github.com/drewsephski/squido/issues/320
 */
 ...
 * Note: tools/ may contain fd/rg binaries extracted by squido, so only warn if it has other files.
 */
