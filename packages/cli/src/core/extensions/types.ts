...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@drewsepsi/squido-cli` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@drewsepsi/squido-cli";
	 *
 ...
 */
export type ExtensionMode = "tui" | "rpc" | "json" | "print" | "web";
...
export interface ExtensionContext {
	...
	/** Gracefully shutdown squido and exit. Available in all contexts. */
	shutdown(): void;
...
/**
 * Action implementations for api.* API methods.
