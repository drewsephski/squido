import type { Transport } from "@drewsepsi/squido-ai";
...
export class SettingsManager {
	...
	getClearOnShrink(): boolean {
		...
		return process.env.SQUIDO_CLEAR_ON_SHRINK === "1";
	}
	...
	getShowHardwareCursor(): boolean {
		return this.settings.showHardwareCursor ?? process.env.SQUIDO_HARDWARE_CURSOR === "1";
	}
