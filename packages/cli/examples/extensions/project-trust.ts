 ...
 *
 *   mkdir -p ~/.squido/agent/extensions
 *   cp packages/coding-agent/examples/extensions/project-trust.ts ~/.squido/agent/extensions/
 *
 * Or:
 *
...
import type { ExtensionAPI, ProjectTrustEventResult } from "@drewsepsi/squido-cli";
