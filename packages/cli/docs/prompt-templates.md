> squido can create prompt templates. Ask it to build one for your workflow.
...
Squido loads prompt templates from:

- Global: `~/.squido/agent/prompts/*.md`
- Project: `.squido/prompts/*.md` (only after the project is trusted)
- Packages: `prompts/` directories or `squido.prompts` entries in `package.json`
