...
Pi bundles core packages for extensions and skills. If you import any of these, list them in `peerDependencies` with a `"*"` range and do not bundle them: `@drewsepsi/squido-ai`, `@drewsepsi/squido-agent-core`, `@drewsepsi/squido-cli`, `@drewsepsi/squido-tui`, `typebox`.
